...
_G.packer_plugins = {
  ...
  kommentary = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/kommentary"
  },
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim"
  },
  ["lualine.nvim"] = {
    loaded = true,
  ...
  ["neoscroll.nvim"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/neoscroll.nvim"
  },
  ...
  ["nvim-cursorword"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/nvim-cursorword"
  },
  ["nvim-lint"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/nvim-lint"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["surround.nvim"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/surround.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
  ...
  ultisnips = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/ultisnips"
  },
  ["vim-bufkill"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/vim-bufkill"
  },
  ["vim-snippets"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/vim-snippets"
  },
  ["which-key.nvim"] = {
    loaded = true,
